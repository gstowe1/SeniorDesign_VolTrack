  ...
  <body style="height: 100%; overflow-y: hidden">
    ...
    <div class="container mt-4 mb-4 shadow-lg" id="master-container">
          <div id="board">
            ...
            <div class="btn btn-primary" id="createBtn">Create Plan</div>  
            <label for="loadBtn" class="btn btn-secondary">
            Load Plan<input type="file" name="loadBtn" id="loadBtn" style="display:none;">
          </label>            
          <!-- <div class="btn btn-secondary" id="loadBtn">Load Plan</div> -->
        </div>
    </div>
  </body>
